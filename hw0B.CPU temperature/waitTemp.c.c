...
int printTemp() {
	...
	temp1 = fopen("/sys/class/hwmon/hwmon4/temp1_input", "r");
	assert(temp1 != NULL);
	temp2 = fopen("/sys/class/hwmon/hwmon4/temp2_input", "r");
	assert(temp2 != NULL);
	temp3 = fopen("/sys/class/hwmon/hwmon4/temp3_input", "r");
	assert(temp3 != NULL);
	temp4 = fopen("/sys/class/hwmon/hwmon4/temp4_input", "r");
	assert(temp4 != NULL);
    ...
    fclose(temp1); fclose(temp2); fclose(temp3); fclose(temp4);  //關閉
